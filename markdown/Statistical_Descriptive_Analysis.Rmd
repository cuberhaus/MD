...
# Create table of the names of out features
#print(kable(names(db), align = "c", booktabs = TRUE) %>%
#       kable_styling(latex_options = "HOLD_position")
      
# Create a table with the variables name and type
#sapply(dbPreprocessed, class)
```
